...
export class GitDetector {
     ...
     */
    async detectRepository(workingPath) {
     ...
     */
    async getCurrentBranch(gitRoot) {
        try {
     ...
     */
    async isGitRepository(workingPath) {
